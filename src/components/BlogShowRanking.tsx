          ...
          <TableBody>
            {players.map((p, i) => (
              ...
              >
                ...
                <TableCell className="text-sm text-foreground">{p.team}</TableCell>
                <TableCell className="text-sm text-muted-foreground hidden sm:table-cell">{p.position}</TableCell>
                <TableCell className={`text-center font-display font-bold text-lg ${ovrColor(p.ovr)}`}>
                  {p.ovr}
                </TableCell>
