  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="page-shell pt-8 max-w-5xl mx-auto">
        ...
        <section className="glass-panel p-6 rounded-xl mb-10">
          <h2 className="text-lg font-display font-bold text-flag-gradient mb-3">🌎 The Untapped 35-Million-Person Demand Wave</h2>
          <p className="text-muted-foreground text-sm leading-7 text-justify mb-4">
            Here's a factor most collectors overlook: Venezuela's population is approximately <strong className="text-foreground">28.4 million</strong> as of 2024, but the nation has experienced a massive migration crisis — over <strong className="text-foreground">7 million people</strong> (around 20–23% of the population) have left in recent years. Combined with the global diaspora, that's roughly <strong className="text-foreground">35 million Venezuelans</strong> worldwide who are largely <strong className="text-foreground">unaware that their national athletes' sports cards hold real monetary value</strong> on platforms like eBay. The culture of sports card collecting and investing hasn't yet penetrated the Venezuelan mainstream the way it has in the U.S. or Japan.
          </p>
          <p className="text-muted-foreground text-sm leading-7 text-justify mb-4">
            Consider what happens when even a small fraction of that population begins to understand the market. If just <strong className="text-foreground">1% of Venezuelans</strong> (350,000 people) entered the hobby as buyers — even casually — the demand shock on a market with only <strong className="text-foreground">{m.totalPsaPop} graded cards</strong> in total PSA population would be extraordinary. Supply is fixed; graded cards don't multiply. A wave of national pride–driven demand would compress supply almost overnight.
          </p>
          <p className="text-muted-foreground text-sm leading-7 text-justify mb-4">
          ...
          <p className="text-muted-foreground text-sm leading-7 text-justify mb-4">
            In fact, today in Venezuela people regularly sell their 90's cards — often in poor, damaged, or bad condition — on Facebook Marketplace and Mercado Libre, <strong className="text-foreground">asking thousands of dollars based purely on sentimental value</strong>, without understanding real market prices based on actual eBay sold data. Most sellers have never heard of <strong className="text-foreground">professional grading, authentication, or proper card preservation</strong>. This disconnect between perceived value and market value is enormous — and it highlights just how early we are. Part of the reason this website exists is to <strong className="text-foreground">create awareness among Venezuelans</strong> about how this market actually works, how to protect and grow the value of their collections, and how to turn a childhood hobby into a real business.
          </p>
          <p className="text-muted-foreground text-sm leading-7 text-justify mb-4">
            And make no mistake — <strong className="text-foreground">Venezuelans love collecting cards</strong>. The country has a rich history of sports card production dating back to the <strong className="text-foreground">1920s</strong>, when early cigarette and caramel cards first appeared. Most notably, <strong className="text-foreground">Topps printed official baseball cards in Venezuela</strong> from 1959 through the mid-1970s (1959, '60, '62, '64, '66, '67, '68, '69, '70, '71, '72, '74, and '77) — making Venezuelan Topps variants some of the most sought-after vintage cards among global collectors today. Beyond Topps, local brands like <strong className="text-foreground">Ovenca, Sports Gráfico, Line-Up</strong>, and others produced their own sets, alongside the ever-popular <strong className="text-foreground">Panini stickers</strong> that became a cultural phenomenon across Latin America. The passion for collecting runs deep — what's missing is the understanding of <em>how valuable these collections can be</em> in today's global market.
          </p>
          <p className="text-muted-foreground text-sm leading-7 text-justify mb-4">
            What makes this even more compelling is that <strong className="text-foreground">Venezuelan professional leagues are growing and expanding</strong>. The local soccer league is on the rise, the already ultra-popular <strong className="text-foreground">Venezuelan basketball league (Superliga de Baloncesto)</strong> continues to draw massive audiences, and the historic winter baseball league — the <strong className="text-foreground"><a href="https://lvbp.com" target="_blank" rel="noopener noreferrer" className="text-vzla-yellow hover:underline">LVBP (Liga Venezolana de Béisbol Profesional)</a></strong> — is no longer the only professional baseball season in the country. Venezuela now also has the <strong className="text-foreground">LMBP (Liga Mayor de Béisbol Profesional)</strong>, a summer league that effectively makes Venezuelan professional baseball a <strong className="text-foreground">year-round operation</strong>. On the international stage, we're seeing <strong className="text-foreground">MLB teams signing Venezuelan prospects for millions of dollars at an increasingly higher volume every year</strong>. The pipeline of elite talent is accelerating, and with it, the potential value of their cards.
          </p>
          <p className="text-muted-foreground text-sm leading-7 text-justify">
