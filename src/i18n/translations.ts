...
export const translations = {
  en: {
    ...
    "sentiment.note": "Indexes are base 100 and averaged across every tracked athlete with a price that day. Sentiment blends breadth (share of athletes up vs. down over 7 days), 7-day index momentum, and price stability, scaled from -100 (bearish) to +100 (bullish). Above +15 is bullish, below -15 is bearish. Informational only, not investment advice.",
    "ml.predictedUp": "{v}% Up",
